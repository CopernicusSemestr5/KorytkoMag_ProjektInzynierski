...
Podczas wielokrotnych prób ich rozwiązywania, różne osoby dochodziły do wspólnych wniosków odnośnie architektury kodu źródłowego tworzonego w celu ich rozwiązania.
...
Można je porównać do znanych przekształceń oraz wzorów matematycznych w rachunku całkowym, gdyż zostały one ściśle zdefiniowane, a osiągniecie efekt końcowy różni się
...
\section{Behawioralne}
    ...
    \subsection{Strategia}
        ...
        Strategia jest potężnym narzędziem, nad którym zaplanowane zostały dalsze plany analizy oraz zrozumienia, w celu eliminacji tego typu wywołań.
        \lstinputlisting[
        language=C++,
