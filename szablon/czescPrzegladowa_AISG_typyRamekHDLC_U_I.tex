...
\subsection{Ramka U}
Jej nazwa pochodzi z języka angielskiego ,,Unnumbered'' co oznacza nienumerowana\cite{WIKI_ENG_HDLC}.
...
\subsection{Ramka I}
Jej nazwa pochodzi z języka angielskiego ,,Information'' co oznacza informacyjna\cite{WIKI_ENG_HDLC}.
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.75]{out/FrameI_Bajt_kontrolny/FrameI_Bajt_kontrolny.png}
	\caption{Ramka informacyjna - ewaluacja bajtu kontrolnego.
		\newline(Opracowanie własne)}
	\label{fig:FrameI_Bajt_kontrolny}
\end{figure}
